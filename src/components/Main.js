        ...
        <div className="flex flex-col sm:flex-row sm:items-center pt-0 justify-center w-full min-h-[58vh] tm:min-h-min tm:w-full sm:min-h-min sm:w-full sm:pt-0 tm:pt-0">
          <div className="flex flex-col justify-center sm:w-[70%] w-full sm:mr-5">
            ...
            <p className="dark:text-[#ccc] text-justify leading-loose pt-5 font-[400] mt-[-.8rem] text-custom-18 sm:text-[1rem] w-[90%] md:w-[95%] tm:w-full sm:w-full sm:mt-0">
              I am passionate about building websites and web applications. I have honed my
              technical skills through diverse projects, both individually and
              in teams. I have built end-to-end web and mobile applications
              using technologies such as HTML, CSS, JavaScript, ReactJS,
              Next.js, Sass, Bootstrap, Tailwind CSS, NodeJS, ExpressJs,
              Git, MongoDB, and MySQL.
            </p>
          </div>
          ...
          <div className="flex place-content-center mt-7 ">
            <div className="flex flex-row sm:flex-col gap-4">
              <a
                rel="noreferrer"
                href="https://www.linkedin.com/in/farjana-akther55/"
                target="_blank"
              >
              ...
              <a
                rel="noreferrer"
                href="https://github.com/farjanasabiha"
                target="_blank"
              >
              ...
              <a
                rel="noreferrer"
                href="https://www.behance.net/farjanasabiha"
                target="_blank"
              >
                <FaBehance thub size={40} className="cursor-pointer" />
              </a>
            </div>
          </div>
        </div>
